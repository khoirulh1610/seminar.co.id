...
<body>
  <div class="wrraper">
    <img class="ticket" src="/ticket/kebumen.png" alt="ticket">
    <div class="card">
      <div class="col">
        <small>Nama</small>
        <h3>{{ $peserta->nama }}</h3>
      ...
      <div class="col">
        ...
        <div style="display: flex;">
          <img class="qr-map" height="80" src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=https://goo.gl/maps/MPwVGBGrDYLq3VvR6" alt="">
          <div>
