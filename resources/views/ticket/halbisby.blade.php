...
<body>
  <div class="wrraper">
    <img class="ticket" src="/ticket/tiketsby.png" alt="ticket">
    <div class="card">
      <div class="col">
        <small>Nama</small>
        <h3>{{ $peserta->nama }}</h3>
      ...
      <div class="col">
        ...
        <div style="display: flex;">
          <img class="qr-map" src="/ticket/tiketsby-qr-lokasi.png" alt="">
          <div>
            <strong>{{ $event->lokasi }}</s>
            <small style="display: block; font-size: 12px; color: #fff; padding: 7px; background-color: rgba(10, 46, 2, .5);
            border-radius: 7px;">Jl. Jenderal S. Parman No.52 - 54, Krajan Kulon, Waru, Kec. Waru, Kabupaten Sidoarjo</small>
          </div>
        </div>
      </div>
    </div>
