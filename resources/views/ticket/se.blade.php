...
<body>
  <div class="wrraper">
    <img class="ticket" src="/ticket/se-bg-ticket.jpeg" alt="ticket">
    <div class="card">
      <div class="col">
        <small>Nama</small>
        <h3>{{ $peserta->nama }}</h3>
      ...
      <div class="col">
        ...
        <div style="display: flex;">
          <img class="qr-map" src="/ticket/se-qr-map.png" alt="">
          <div>
            <strong>{{ $event->lokasi }}</s>
            <small style="display: block; font-size: 11px">Jl. Student Castle, Kledokan, Caturtunggal, Kec. Depok, Kab. Sleman <br /> Daerah Istimewa Yogyakarta</small>
          </div>
        </div>
      </div>
    </div>
