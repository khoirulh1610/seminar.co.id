                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="nama"
                                                                id="nama" placeholder="Nama Event">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select name="notif" id="notif" class="form-control">
                                                                <option value="">--</option>
                                                                @foreach ($notif as $n)
                                                                    <option value="{{ $n->id }}">{{ $n->id }} - {{ $n->phone }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                ...
                                                <div class="basic-form">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea type="text" class="form-control" name="pendaftaran" id="pendaftaran" style="height:300px;"
                                                                placeholder="Copywriting Pendaftaran 1"></textarea>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Copywriting Pendaftaran 2</label>
                                                            <textarea type="text" class="form-control" name="pendaftaran2" style="height:300px;"
                                                                placeholder="Copywriting Pendaftaran 2"></textarea>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Copywriting Pendaftaran untuk Referral</label>
                                                            <textarea type="text" class="form-control" name="pendaftaran_ref"
                                                                style="height:300px;"placeholder="Copywriting Pendaftaran untuk Referral"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="basic-form">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea type="text" class="form-control" name="cw_fb" rows="3" style="height: 300px"
                                                                placeholder="Copy Writing untuk Facebook masih kosong"></textarea>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <div class="d-flex justify-content-between">
                                                            ...
                                                            <textarea type="text" class="form-control" name="cw_ig" rows="3" style="height: 300px"
                                                                placeholder="Copy Writing untuk Instagram masih kosong"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
