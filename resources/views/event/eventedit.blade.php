                                        ...
                                        <div class="basic-form">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="link_zoom" id="link_zoom" placeholder="Link Zoom" value="{{ $event->link_zoom }}"">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="zoom_id" id="zoom_id" class="form-control">
                                                        ...
                                                        @foreach($zoom_id as $z)
                                                            <option value="{{$z->id}}" {{ $z->id == $event->zoom_id ? 'selected' : '' }} >{{$z->name}} || {{ $z->email }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Meeting ID</label>
                                                    <input type="number" name="meet_id" id="meet_id" class="form-control" value="{{ $event->meeting_id }}">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Produk</label>
                                                    <select name="produk" id="produk" class="form-control">
                                                        ...
                                                        @foreach($produk_id as $pr)
                                                            <option value="{{$pr->name}}" {{ $pr->name == $event->produk ? 'selected' : '' }}>{{$pr->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select name="status" id="" class="form-control">
                                                        <option value="1" {{ $event->status == '1' ? 'selected' : '' }}>Available</option>
                                                        <option value="0" {{ $event->status == '0' ? 'selected' : '' }}>Closed</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="tanggal" id="" class="form-control date-format1" value="{{$event->tgl_event}}">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Open Register</label>
                                                    <input type="text" id="" name="open" class="form-control date-format1" value="{{$event->open_register}}">
                                                </div>
                                                <div class="form-group col-md-4">
                                        ...
                                        <div class="basic-form">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea type="text" class="form-control" name="cw_fb" rows="3" placeholder="Copy Writing untuk Facebook masih kosong">{{$event->cw_fb}}</textarea>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <div class="d-flex justify-content-between">
                                                    ...
                                                    <textarea type="text" class="form-control" name="cw_ig" rows="3" placeholder="Copy Writing untuk Instagram masih kosong">{{$event->cw_ig}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
