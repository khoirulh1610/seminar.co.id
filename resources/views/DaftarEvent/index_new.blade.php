...
<head>
  ...
  <title>REGISTRASI - {{ $event->event_title ?? '' }}</title>
  <!-- Google font-->
  ...
  <div class="page-wrapper landing-page">
    ...
    <div class="page-body-wrapper">
      ...
      <section class="demo-section section-py-space" id="Applications">
        ...
        <div class="custom-container" id="cek_reg">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-sm-12 wow fadeIn">
              <div>
                <div class="register-sec-details">
                      <label for="cek_Wa">Masukkan Nomor Whatsapp</label>
                      <input type="text" class="form-control" id="cek_wa">
                      <button class="btn btn-info m-1" id="btn_Cek_wa">Daftar</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="custom-container d-none" id="reg">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-sm-12 wow fadeIn">
              <div>
                <div class="register-sec-details">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-md-5">
                              <div class="wow fadeInUp" data-wow-duration="100ms">
                                ...
                                <select type="text" id="sapaan" name="sapaan" placeholder="Sapaan" class="form-control" required>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="wow fadeInUp" data-wow-duration="200ms">
                                ...
                                <input type="text" name="nama" id="nama" placeholder="Masukkan Nama Anda" class="form-control _string" autocomplete="off" required>
                              </div>
                              <!--form-field end-->
                            </div>
                            <div class="col-sm-12">
                              <div class="wow fadeInUp" data-wow-duration="200ms">
                                ...
                                <input type="text" name="profesi" id="profesi" placeholder="Perkerjaan / Bisnis anda" class="form-control _string" autocomplete="off">
                              </div>
                              <!--form-field end-->
                            </div>
                            @if ($event->produk=='maxwin')
                                <div class="col-sm-12">
                                  <div class="wow fadeInUp" data-wow-duration="200ms">
                                    ...
                                    <select type="text" name="jabatan" class="form-control form-select jabatan">
                                ...
                                <div class="col-sm-12">
                                  <div class="wow fadeInUp" data-wow-duration="200ms">
                                    ...
                                    <select type="text" name="bidang_usaha" class="form-control form-select usaha">
                                      <option value="">--Pilih salah satu--</option>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="wow fadeInUp" data-wow-duration="200ms">
                                ...
                                <input type="email" name="email" id="email" placeholder="demo@gmail.com" class="form-control _email" autocomplete="off" required>
                              </div>
                              <!--form-field end-->
                            </div>
                            <div class="col-sm-6">
...
$('#btn_Cek_wa').on('click',function(){
    let phone = $('#cek_wa').val();
    $.ajax({
      url : "{{url('cekwa')}}",
      data : {phone:phone},
      success: function(data){
        if(data.wa.status){
          ...
          $('#cek_reg').addClass('d-none');
          $('#phone').val(phone);
          if(data.seminar){
            $('#sapaan').val(data.seminar.sapaan).change();
            $('#panggilan').val(data.seminar.panggilan);
            $('#nama').val(data.seminar.nama);
            $('#email').val(data.seminar.email);
            $('#phone').val(data.seminar.phone);
            $('#profesi').val(data.seminar.profesi);
            $('#provinsi').val(data.seminar.prov_id).change();
            $('#kota').val(data.seminar.kota_id).change();
            $('#tanggal').val(data.seminar.b_tanggal.toString().padStart(2, "0")).change();
            $('#bulan').val(data.seminar.b_bulan.toString().padStart(2, "0")).change();
            $('#tahun').val(data.seminar.b_tahun).change();
            $('#alamat').val(data.seminar.alamat);  
            $('.jabatan').val(data.seminar.jabatan).change();
            $('.usaha').val(data.seminar.bidang_usaha).change();
          }
        }else{
          alert('Pastikan Nomor anda terdaftar di whatsapp');
        }
      }
    });
});
